...
control MyEgress(inout headers hdr,
    ...
    apply {
        ...
        if (standard_metadata.instance_type == PKT_INSTANCE_TYPE_INGRESS_CLONE) {
            ...
            // totallen只算固定首部+option长度 20+12
            hdr.ipv4.protocol = 4;// IPv4
            hdr.ipv4.totalLen = (bit<16>)(20 + 12);
            // hdr.ipv4.totalLen / 4
            hdr.ipv4.ihl = 8;
            // 截断 ether(14 Bytes)+IPv4(20+12 Bytes) header = 46 bytes 之后的部分 (截断option之后的)
